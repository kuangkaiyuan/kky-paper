...
\textbf{Step6:} Construct the multiple VM, which is composed of the \emph{VMNum} sets of handlers and \emph{2*VMNum} sets of driver-data. \FIXME{Please update this diagram and merge it with the Diversifying paragraph.}
